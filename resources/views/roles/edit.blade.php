                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form id="AddEditRole" name="AddEditRole" class="form-horizontal" method="POST"
                                action="{{ url('/Roles') }}/{{ $role->id }}" autocomplete="off">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <table id="example" class="table table-bordered second" style="width:100%">
                                            <tr>
                                                ...
                                                <td>{!! Form::text('name', $role->name, ['placeholder' => 'Name', 'class' => 'form-control']) !!}</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach ($permission as $value)
                                                            ...
                                                            <div class="col-3">
                                                                <div class="icheck-material-primary">
                                                                    {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['id' => 'chk_' . $i, 'class' => 'name checkbox']) }}
